...
export default {
    ...
    updateBlockText(jElement, panelStateConfiguration){
        return this.extension.updateBlockText(jElement, panelStateConfiguration);
    },

    addBlockCustomAttibutes(jElement, key, value)
    {
        this.extension.addBlockCustomAttibutes(jElement, key, value);
    },
